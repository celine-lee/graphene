...
class Field(MountedType):
    ...
    All class attributes on an ObjectType are implicitly mounted as Field.
    """
    ...
    def __init__(
        ...
        **extra_args,
        ...
        assert not (source and resolver), "A Field cannot have both a source and a resolver."
        assert not callable(
            default_value
        ), f"The default value cannot be a function but received type '{base_type(default_value)}'."
